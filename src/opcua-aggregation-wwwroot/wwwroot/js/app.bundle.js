    ...
    ***************************************************************************** */
    ...
    var InstantiationError = class _InstantiationError extends TypeError {
      ...
      constructor(error, { identifier, parentChain, ...options }) {
        const message = typeof error === "string" ? error : error instanceof Error ? error.message : typeof error === "object" && error != null && "message" in error && typeof error.message === "string" ? error.message : undefined;
        const stack = typeof error === "string" ? undefined : error instanceof Error ? error.stack : typeof error === "object" && error != null && "stack" in error && typeof error.stack === "string" ? error.stack : undefined;
